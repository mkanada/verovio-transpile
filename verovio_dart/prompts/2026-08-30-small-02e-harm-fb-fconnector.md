# 02e — view_control.dart: drawHarm, drawFb, drawFConnector, _getFYRel
...
|---|---|---|---|---|
| `drawHarm` | — | — | — | `origin/src/src/view_control.cpp` |
| `drawFb` | — | — | — | `origin/src/src/view_control.cpp` |
| `drawFConnector` | — | — | — | `origin/src/src/view_control.cpp` |
| `_getFYRel` | — | — | — | `origin/src/src/view_control.cpp` |

**Total pontos desta unidade:** ~60
**Famílias afetadas:** harm
...
```bash
tool/task_check.sh view_control.dart harm
```
