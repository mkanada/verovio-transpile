# 02g — view_control.dart: drawSylConnector, drawSylConnectorLines, _getSylYRel, _calcHyphenLength, _adjustToLyricSizeRet

## Contexto (não precisa ler mais nada)

Você vai tipar 5 método(s) de `lib/src/rendering/view_control.dart`, tirando `as dynamic` e `catch (_)`. Execução mecânica via helper `_dyn` (ver relatório medium-02).
...
|---|---|---|---|---|
| `drawSylConnector` | — | — | — | `origin/src/src/view_control.cpp` |
| `drawSylConnectorLines` | — | — | — | `origin/src/src/view_control.cpp` |
| `_getSylYRel` | — | — | — | `origin/src/src/view_control.cpp` |
| `_calcHyphenLength` | — | — | — | `origin/src/src/view_control.cpp` |
| `_adjustToLyricSizeRet` | — | — | — | `origin/src/src/view_control.cpp` |

**Total pontos desta unidade:** ~36
**Famílias afetadas:** lyric, syl
...
```bash
tool/task_check.sh view_control.dart lyric syl
```
