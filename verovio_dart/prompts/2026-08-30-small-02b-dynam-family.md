# 02b — view_control.dart: drawDynam, drawDynamSymbolOnly, _collectDynamText
...
|---|---|---|---|---|
| `drawDynam` | — | — | — | `origin/src/src/view_control.cpp` |
| `drawDynamSymbolOnly` | — | — | — | `origin/src/src/view_control.cpp` |
| `_collectDynamText` | — | — | — | `origin/src/src/view_control.cpp` |

**Total pontos desta unidade:** ~68
**Famílias afetadas:** dynam
...
```bash
tool/task_check.sh view_control.dart dynam
```
