# 02c — view_control.dart: drawOctave, _getOctaveGlyph, _getOctaveLineWidth, _getBracketSpanLineWidth
...
|---|---|---|---|---|
| `drawOctave` | — | — | — | `origin/src/src/view_control.cpp` |
| `_getOctaveGlyph` | — | — | — | `origin/src/src/view_control.cpp` |
| `_getOctaveLineWidth` | — | — | — | `origin/src/src/view_control.cpp` |
| `_getBracketSpanLineWidth` | — | — | — | `origin/src/src/view_control.cpp` |

**Total pontos desta unidade:** ~52
**Famílias afetadas:** octave
...
```bash
tool/task_check.sh view_control.dart octave
```
