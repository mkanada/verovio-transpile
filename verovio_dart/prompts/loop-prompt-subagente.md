...
1. **INÍCIO — Baseline Geral:** Determine `alvo_ativo` aplicando a regra
   ...
   senão (X = 621) alvo = numérico (e usa `erros_num_antes`). Leia os
    ...
    rodam APENAS no final, antes da recomendação** (passo 3.c), não no início
