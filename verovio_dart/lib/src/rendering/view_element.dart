...
const int _smuflE0A0NoteheadDoubleWhole = smuflE0A0NoteheadDoubleWhole;
const int _smuflE0A1NoteheadDoubleWholeSquare = smuflE0A1NoteheadDoubleWholeSquare;
const int _smuflE0A2NoteheadWhole = smuflE0A2NoteheadWhole;
const int _smuflE0A3NoteheadHalf = smuflE0A3NoteheadHalf;
const int _smuflE0A4NoteheadBlack = smuflE0A4NoteheadBlack;
const int _smuflE0A5NoteheadNull = smuflE0A5NoteheadNull;
const int _smuflE0A9NoteheadXBlack = smuflE0A9NoteheadXBlack;
const int _smuflE0AFNoteheadPlusBlack = smuflE0AFNoteheadPlusBlack;
const int _smuflE0B5NoteheadWholeWithX = smuflE0B5NoteheadWholeWithX;
const int _smuflE0B6NoteheadHalfWithX = smuflE0B6NoteheadHalfWithX;
const int _smuflE0B8NoteheadSquareWhite = smuflE0B8NoteheadSquareWhite;
const int _smuflE0B9NoteheadSquareBlack = smuflE0B9NoteheadSquareBlack;
const int _smuflE0D9NoteheadDiamondHalf = smuflE0D9NoteheadDiamondHalf;
const int _smuflE0DBNoteheadDiamondBlack = smuflE0DBNoteheadDiamondBlack;
const int _smuflE0DCNoteheadDiamondBlackWide = smuflE0DCNoteheadDiamondBlackWide;
const int _smuflE0DENoteheadDiamondWhiteWide = smuflE0DENoteheadDiamondWhiteWide;
const int _smuflE0FANoteheadWholeFilled = smuflE0FANoteheadWholeFilled;
const int _smuflE0FBNoteheadHalfFilled = smuflE0FBNoteheadHalfFilled;
const int _smuflE101NoteheadSlashHorizontalEnds = smuflE101NoteheadSlashHorizontalEnds;
const int _smuflE102NoteheadSlashWhiteWhole = smuflE102NoteheadSlashWhiteWhole;
const int _smuflE103NoteheadSlashWhiteHalf = smuflE103NoteheadSlashWhiteHalf;
const int _smuflE220Tremolo1 = smuflE220Tremolo1;
const int _smuflE221Tremolo2 = smuflE221Tremolo2;
const int _smuflE222Tremolo3 = smuflE222Tremolo3;
const int _smuflE223Tremolo4 = smuflE223Tremolo4;
const int _smuflE224Tremolo5 = smuflE224Tremolo5;
const int _smuflE22ABuzzRoll = smuflE22ABuzzRoll;
const int _smuflE240Flag8thUp = smuflE240Flag8thUp;
const int _smuflE241Flag8thDown = smuflE241Flag8thDown;
const int _smuflE242Flag16thUp = smuflE242Flag16thUp;
const int _smuflE243Flag16thDown = smuflE243Flag16thDown;
const int _smuflE244Flag32ndUp = smuflE244Flag32ndUp;
const int _smuflE245Flag32ndDown = smuflE245Flag32ndDown;
const int _smuflE246Flag64thUp = smuflE246Flag64thUp;
const int _smuflE247Flag64thDown = smuflE247Flag64thDown;
const int _smuflE248Flag128thUp = smuflE248Flag128thUp;
const int _smuflE249Flag128thDown = smuflE249Flag128thDown;
const int _smuflE24AFlag256thUp = smuflE24AFlag256thUp;
const int _smuflE24BFlag256thDown = smuflE24BFlag256thDown;
const int _smuflE24CFlag512thUp = smuflE24CFlag512thUp;
const int _smuflE24DFlag512thDown = smuflE24DFlag512thDown;
const int _smuflE24EFlag1024thUp = smuflE24EFlag1024thUp;
const int _smuflE24FFlag1024thDown = smuflE24FFlag1024thDown;
const int _smuflE260AccidentalFlat = smuflE260AccidentalFlat;
const int _smuflE261AccidentalNatural = smuflE261AccidentalNatural;
const int _smuflE26AAccidentalParensLeft = smuflE26AAccidentalParensLeft;
const int _smuflE26BAccidentalParensRight = smuflE26BAccidentalParensRight;
const int _smuflE500Repeat1Bar = smuflE500Repeat1Bar;
const int _smuflE501Repeat2Bars = smuflE501Repeat2Bars;
const int _smuflE504RepeatBarSlash = smuflE504RepeatBarSlash;
const int _smuflE645VocalSprechgesang = smuflE645VocalSprechgesang;
const int _smuflE26CAccidentalBracketLeft = smuflE26CAccidentalBracketLeft;
const int _smuflE26DAccidentalBracketRight = smuflE26DAccidentalBracketRight;
const int _smuflE9E0MedRenFlatSoftB = smuflE9E0MedRenFlatSoftB;
const int _smuflE9E2MedRenNatural = smuflE9E2MedRenNatural;
const int _smuflE9E3MedRenSharpCroix = smuflE9E3MedRenSharpCroix;
// Artic
const int _smuflE4A0ArticAccentAbove = smuflE4A0ArticAccentAbove;
const int _smuflE4A1ArticAccentBelow = smuflE4A1ArticAccentBelow;
const int _smuflE4A2ArticStaccatoAbove = smuflE4A2ArticStaccatoAbove;
const int _smuflE4A3ArticStaccatoBelow = smuflE4A3ArticStaccatoBelow;
const int _smuflE4A4ArticTenutoAbove = smuflE4A4ArticTenutoAbove;
const int _smuflE4A5ArticTenutoBelow = smuflE4A5ArticTenutoBelow;
const int _smuflE4A6ArticStaccatissimoAbove = smuflE4A6ArticStaccatissimoAbove;
const int _smuflE4A7ArticStaccatissimoBelow = smuflE4A7ArticStaccatissimoBelow;
const int _smuflE4A8ArticStaccatissimoWedgeAbove = smuflE4A8ArticStaccatissimoWedgeAbove;
const int _smuflE4A9ArticStaccatissimoWedgeBelow = smuflE4A9ArticStaccatissimoWedgeBelow;
const int _smuflE4AAArticStaccatissimoStrokeAbove = smuflE4AAArticStaccatissimoStrokeAbove;
const int _smuflE4ABArticStaccatissimoStrokeBelow = smuflE4ABArticStaccatissimoStrokeBelow;
const int _smuflE4ACArticMarcatoAbove = smuflE4ACArticMarcatoAbove;
const int _smuflE4ADArticMarcatoBelow = smuflE4ADArticMarcatoBelow;
const int _smuflE610StringsDownBow = smuflE610StringsDownBow;
const int _smuflE611StringsDownBowTurned = smuflE611StringsDownBowTurned;
const int _smuflE612StringsUpBow = smuflE612StringsUpBow;
const int _smuflE613StringsUpBowTurned = smuflE613StringsUpBowTurned;
const int _smuflE614StringsHarmonic = smuflE614StringsHarmonic;
const int _smuflE630PluckedSnapPizzicatoBelow = smuflE630PluckedSnapPizzicatoBelow;
const int _smuflE631PluckedSnapPizzicatoAbove = smuflE631PluckedSnapPizzicatoAbove;
const int _smuflE633PluckedLeftHandPizzicato = smuflE633PluckedLeftHandPizzicato;
const int _smuflE636PluckedWithFingernails = smuflE636PluckedWithFingernails;
const int _smuflE638PluckedDamp = smuflE638PluckedDamp;
const int _smuflE639PluckedDampAll = smuflE639PluckedDampAll;
const int _smuflE5E5BrassMuteClosed = smuflE5E5BrassMuteClosed;
...
const int _smuflE08DTimeSigPlusSmall = smuflE08DTimeSigPlusSmall;
// Rest
const int _smuflE4E0RestMaxima = smuflE4E0RestMaxima;
const int _smuflE4E1RestLonga = smuflE4E1RestLonga;
const int _smuflE4E2RestDoubleWhole = smuflE4E2RestDoubleWhole;
const int _smuflE4E3RestWhole = smuflE4E3RestWhole;
const int _smuflE4E4RestHalf = smuflE4E4RestHalf;
const int _smuflE4E5RestQuarter = smuflE4E5RestQuarter;
const int _smuflE4E6Rest8th = smuflE4E6Rest8th;
const int _smuflE4E7Rest16th = smuflE4E7Rest16th;
const int _smuflE4E8Rest32nd = smuflE4E8Rest32nd;
const int _smuflE4E9Rest64th = smuflE4E9Rest64th;
const int _smuflE4EARest128th = smuflE4EARest128th;
const int _smuflE4EBRest256th = smuflE4EBRest256th;
const int _smuflE4ECRest512th = smuflE4ECRest512th;
const int _smuflE4EDRest1024th = smuflE4EDRest1024th;
const int _smuflE9F0MensuralRestMaxima = smuflE9F0MensuralRestMaxima;
const int _smuflE9F2MensuralRestLongaImperfecta = smuflE9F2MensuralRestLongaImperfecta;
const int _smuflE9F3MensuralRestBrevis = smuflE9F3MensuralRestBrevis;
const int _smuflE9F4MensuralRestSemibrevis = smuflE9F4MensuralRestSemibrevis;
const int _smuflE9F5MensuralRestMinima = smuflE9F5MensuralRestMinima;
const int _smuflE9F6MensuralRestSemiminima = smuflE9F6MensuralRestSemiminima;
const int _smuflE9F7MensuralRestFusa = smuflE9F7MensuralRestFusa;
const int _smuflE9F8MensuralRestSemifusa = smuflE9F8MensuralRestSemifusa;
// Custos
const int _smuflEA02MensuralCustosUp = smuflEA02MensuralCustosUp;
const int _smuflEA06ChantCustosStemUpPosMiddle = smuflEA06ChantCustosStemUpPosMiddle;
// Clef
const int _smuflE050Gclef = smuflE050Gclef;
const int _smuflE051Gclef15mb = smuflE051GClef15mb;
const int _smuflE052Gclef8vb = smuflE052GClef8vb;
const int _smuflE053Gclef8va = smuflE053GClef8va;
const int _smuflE054Gclef15ma = smuflE054GClef15ma;
const int _smuflE055Gclef8vbOld = smuflE055GClef8vbOld;
const int _smuflE05CGclef = smuflE05CCclef; // C clef
const int _smuflE05DCclef8vb = smuflE05DCclef8vb;
const int _smuflE062Fclef = smuflE062Fclef;
const int _smuflE063Fclef15mb = smuflE063FClef15mb;
const int _smuflE064Fclef8vb = smuflE064FClef8vb;
const int _smuflE065Fclef8va = smuflE065FClef8va;
const int _smuflE066Fclef15ma = smuflE066FClef15ma;
const int _smuflE069PercClef1 = smuflE069UnpitchedPercussionClef1;
const int _smuflE06DTabClef = smuflE06D6stringTabClef;
const int _smuflE07AGClefChange = smuflE07AGClefChange;
const int _smuflE07BCClefChange = smuflE07BCClefChange;
const int _smuflE07BFClefChange = smuflE07CFClefChange;
const int _smuflE900MensuralGclef = smuflE900MensuralGclef;
const int _smuflE901MensuralGclefPetrucci = smuflE901MensuralGclefPetrucci;
const int _smuflE902ChantFclef = smuflE902ChantFclef;
const int _smuflE904MensuralFclefPetrucci = smuflE904MensuralFclefPetrucci;
const int _smuflE906ChantCclef = smuflE906ChantCclef;
const int _smuflE907MensuralCclefPetrucciLowest = smuflE907MensuralCclefPetrucciPosLowest;
const int _smuflE908MensuralCclefPetrucciLow = smuflE908MensuralCclefPetrucciPosLow;
const int _smuflE909MensuralCclefPetrucciMiddle = smuflE909MensuralCclefPetrucciPosMiddle;
const int _smuflE90AMensuralCclefPetrucciHigh = smuflE90AMensuralCclefPetrucciPosHigh;
const int _smuflE90BMensuralCclefPetrucciHighest = smuflE90BMensuralCclefPetrucciPosHighest;
const int _smuflE1E7AugmentationDot = smuflE1E7AugmentationDot;
...
extension ViewElement on View {
  ...
  void drawLayerElement(DeviceContext dc, LayerElement element, Layer layer,
    ...
    } else if (element.isClass(ClassId.episema)) {
