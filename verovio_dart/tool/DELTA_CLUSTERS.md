...
|---|---|---|---|---|
| 1 | `stem/path @d` | 185 | 7324 | `-1` (35 arq), `-208` (18 arq), `1` (17 arq), `25` (16 arq), `2` (16 arq) |
| 2 | `staff/path @d` | 159 | 8003 | `1` (11 arq), `2` (9 arq), `25` (9 arq), `4` (8 arq), `-2` (6 arq) |
| 3 | `notehead/use @transform` | 156 | 4376 | `25` (16 arq), `2` (14 arq), `4` (10 arq), `1` (10 arq), `3` (8 arq) |
| 4 | `barLine/path @d` | 151 | 2562 | `1` (10 arq), `2` (9 arq), `25` (9 arq), `4` (8 arq), `-1` (6 arq) |
| 5 | `clef/use @transform` | 118 | 300 | `2` (8 arq), `4` (5 arq), `1` (5 arq), `3` (3 arq), `-1` (3 arq) |
| 6 | `beam/polygon @points` | 117 | 6850 | `-1` (19 arq), `1` (11 arq), `-208` (11 arq), `25` (9 arq), `2` (9 arq) |
| 7 | `ledgerLines/path @d` | 104 | 2845 | `2` (9 arq), `1` (7 arq), `25` (6 arq), `4` (6 arq), `-1` (5 arq) |
| 8 | `slur/path @d` | 93 | 3850 | `2` (73 arq), `3` (66 arq), `1` (65 arq), `4` (45 arq), `-1` (40 arq) |
| 9 | `accid/use @transform` | 77 | 711 | `4` (6 arq), `28` (5 arq), `-26` (5 arq), `26` (4 arq), `12` (3 arq) |
| 10 | `system/path @d` | 74 | 137 | `4` (5 arq), `2` (4 arq), `1` (4 arq), `3` (3 arq), `363` (2 arq) |
| 11 | `meterSig/use @transform` | 71 | 229 | `2` (6 arq), `4` (4 arq), `1` (4 arq), `190` (2 arq), `3` (2 arq) |
| 12 | `grpSym/path @d` | 66 | 938 | `2` (6 arq), `4` (5 arq), `1` (5 arq), `3` (4 arq), `45` (3 arq) |
| 13 | `artic/use @transform` | 51 | 674 | `427` (16 arq), `540` (14 arq), `360` (11 arq), `900` (11 arq), `180` (10 arq) |
| 14 | `rest/use @transform` | 50 | 380 | `4` (3 arq), `2` (3 arq), `8` (3 arq), `-12` (3 arq), `12` (2 arq) |
| 15 | `keyAccid/use @transform` | 48 | 336 | `4` (4 arq), `2` (3 arq), `-2` (2 arq), `-12` (2 arq), `190` (2 arq) |
| 16 | `flag/use @transform` | 43 | 445 | `2` (4 arq), `4` (4 arq), `25` (3 arq), `12` (3 arq), `-2` (3 arq) |
...
| 22 | `dynam/use @transform` | 28 | 45 | `2` (3 arq), `-354` (2 arq), `372` (2 arq), `185` (2 arq), `525` (2 arq) |
