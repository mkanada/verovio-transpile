...
- Divergências (nível de número): 3739
...
|---|---|---|---|---|
| 1 | `stem/path @d` | 20 | 476 | `1` (3 arq), `162` (2 arq), `8` (1 arq), `-1` (1 arq), `-64` (1 arq) |
| 2 | `staff/path @d` | 16 | 975 | `1` (3 arq), `-1` (2 arq), `-2` (2 arq), `8` (1 arq), `-22` (1 arq) |
| 3 | `barLine/path @d` | 16 | 328 | `1` (3 arq), `-1` (2 arq), `-2` (2 arq), `-11` (1 arq), `8` (1 arq) |
| 4 | `notehead/use @transform` | 16 | 270 | `1` (2 arq), `162` (2 arq), `8` (1 arq), `-1` (1 arq), `2` (1 arq) |
| 5 | `slur/path @d` | 15 | 167 | `-1` (10 arq), `1` (8 arq), `-2` (6 arq), `-3` (2 arq), `4` (2 arq) |
| 6 | `beam/polygon @points` | 14 | 408 | `-1` (1 arq), `15` (1 arq), `-64` (1 arq), `22` (1 arq), `221` (1 arq) |
| 7 | `clef/use @transform` | 13 | 25 | `1` (2 arq), `-64` (1 arq), `-22` (1 arq), `-19` (1 arq), `22` (1 arq) |
...
| 12 | `meterSig/use @transform` | 8 | 24 | `1` (2 arq), `-64` (1 arq), `22` (1 arq), `8` (1 arq), `15` (1 arq) |
| 13 | `accid/use @transform` | 7 | 24 | `22` (1 arq), `8` (1 arq), `15` (1 arq), `-19` (1 arq), `-208` (1 arq) |
| 14 | `tupletNum/use @transform` | 7 | 14 | `-180` (3 arq), `9` (2 arq), `-1` (1 arq), `99` (1 arq) |
| 15 | `system/path @d` | 7 | 13 | `-19` (1 arq), `-64` (1 arq), `22` (1 arq), `8` (1 arq), `-1` (1 arq) |
| 16 | `grpSym/path @d` | 6 | 80 | `-19` (1 arq), `-64` (1 arq), `22` (1 arq), `-1` (1 arq), `15` (1 arq) |
| 17 | `mNum/text @y` | 6 | 11 | `8` (1 arq), `-19` (1 arq), `-64` (1 arq), `22` (1 arq), `-1` (1 arq) |
