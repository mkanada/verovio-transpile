...
| 5 | `slur/path @d` | 93 | 3500 | `2` (81 arq), `1` (71 arq), `3` (64 arq), `-1` (51 arq), `4` (43 arq) |
| 6 | `clef/use @transform` | 83 | 222 | `2` (8 arq), `1` (5 arq), `4` (4 arq), `-1` (4 arq), `3` (4 arq) |
| 7 | `beam/polygon @points` | 75 | 4384 | `-208` (12 arq), `2` (8 arq), `4` (7 arq), `1` (6 arq), `90` (5 arq) |
| 8 | `ledgerLines/path @d` | 72 | 1747 | `2` (9 arq), `1` (6 arq), `-1` (4 arq), `4` (4 arq), `96` (3 arq) |
...
| 11 | `accid/use @transform` | 51 | 298 | `4` (5 arq), `-1` (4 arq), `26` (3 arq), `3` (3 arq), `96` (3 arq) |
| 12 | `grpSym/path @d` | 50 | 764 | `1` (5 arq), `2` (5 arq), `3` (5 arq), `4` (4 arq), `45` (4 arq) |
| 13 | `artic/use @transform` | 50 | 630 | `427` (16 arq), `540` (13 arq), `360` (11 arq), `900` (11 arq), `180` (10 arq) |
| 14 | `rest/use @transform` | 41 | 343 | `2` (4 arq), `4` (3 arq), `90` (3 arq), `12` (2 arq), `189` (2 arq) |
| 15 | `tie/path @d` | 39 | 1047 | `1` (36 arq), `-1` (25 arq), `-2` (16 arq), `2` (6 arq), `3` (4 arq) |
...
| 23 | `tupletNum/use @transform` | 18 | 63 | `-1` (3 arq), `1` (2 arq), `90` (2 arq), `-180` (2 arq), `1787` (1 arq) |
| 24 | `note/polygon @points` | 17 | 352 | `-8` (17 arq), `-4` (13 arq) |
| 25 | `dots/ellipse @cx` | 14 | 102 | `-219` (3 arq), `192` (2 arq), `96` (2 arq), `-225` (2 arq), `-198` (2 arq) |
