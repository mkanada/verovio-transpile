...
- Arquivos com divergência numérica: 365
- Divergências (nível de número): 57752
- Assinaturas distintas (classe/tag @atributo): 105
...
|---|---|---|---|---|
| 1 | `stem/path @d` | 246 | 9168 | `-1` (37 arq), `-208` (26 arq), `90` (22 arq), `1` (20 arq), `25` (17 arq) |
| 2 | `staff/path @d` | 203 | 11110 | `1` (14 arq), `-1` (10 arq), `25` (10 arq), `2` (8 arq), `4` (7 arq) |
| 3 | `notehead/use @transform` | 198 | 6178 | `-208` (18 arq), `25` (17 arq), `-1` (16 arq), `1` (13 arq), `2` (13 arq) |
| 4 | `barLine/path @d` | 192 | 3313 | `1` (13 arq), `-1` (10 arq), `25` (10 arq), `2` (8 arq), `4` (7 arq) |
| 5 | `clef/use @transform` | 162 | 383 | `2` (7 arq), `1082` (6 arq), `1` (5 arq), `4` (4 arq), `363` (3 arq) |
| 6 | `ledgerLines/path @d` | 134 | 3813 | `-1` (10 arq), `2` (8 arq), `1` (8 arq), `1082` (6 arq), `25` (6 arq) |
| 7 | `beam/polygon @points` | 130 | 7692 | `-1` (21 arq), `-208` (15 arq), `1` (11 arq), `25` (9 arq), `2` (9 arq) |
...
| 10 | `slur/path @d` | 93 | 3935 | `2` (72 arq), `3` (64 arq), `1` (63 arq), `4` (42 arq), `-1` (38 arq) |
| 11 | `accid/use @transform` | 87 | 1071 | `4` (6 arq), `28` (5 arq), `-26` (5 arq), `12` (3 arq), `358` (3 arq) |
| 12 | `grpSym/path @d` | 76 | 1102 | `4` (4 arq), `1` (4 arq), `2` (4 arq), `3` (4 arq), `724` (2 arq) |
| 13 | `rest/use @transform` | 68 | 482 | `-1` (3 arq), `4` (3 arq), `1082` (3 arq), `816` (3 arq), `-12` (3 arq) |
| 14 | `keyAccid/use @transform` | 64 | 405 | `4` (4 arq), `358` (3 arq), `816` (3 arq), `-2` (2 arq), `-12` (2 arq) |
| 15 | `flag/use @transform` | 56 | 531 | `-45` (5 arq), `1` (5 arq), `2` (4 arq), `90` (4 arq), `4` (4 arq) |
| 16 | `dots/ellipse @cy` | 52 | 549 | `-180` (12 arq), `180` (4 arq), `360` (3 arq), `814` (2 arq), `7` (2 arq) |
| 17 | `artic/use @transform` | 51 | 692 | `427` (15 arq), `540` (13 arq), `360` (11 arq), `900` (9 arq), `180` (8 arq) |
| 18 | `mNum/text @y` | 42 | 56 | `4` (4 arq), `1` (3 arq), `12` (2 arq), `902` (2 arq), `2` (2 arq) |
| 19 | `dots/ellipse @cx` | 41 | 505 | `-226` (12 arq), `-219` (3 arq), `25` (2 arq), `-225` (2 arq), `-198` (2 arq) |
| 20 | `tie/path @d` | 39 | 1230 | `1` (30 arq), `-1` (21 arq), `-2` (13 arq), `2` (6 arq), `1082` (3 arq) |
| 21 | `dynam/use @transform` | 33 | 52 | `358` (2 arq), `372` (2 arq), `185` (2 arq), `525` (2 arq), `-354` (2 arq) |
| 22 | `tupletNum/use @transform` | 30 | 110 | `1` (6 arq), `-1` (5 arq), `5` (2 arq), `-180` (2 arq), `25` (2 arq) |
