...
Lavagem de tipo (_dyn + as dynamic + declarações dynamic): 156
Engolidores silenciosos (catch sem rethrow nem log): 2
Supressões de erro de tipo: 0
Dívida total (D = A + B + C): 158

Gerado em 2026-09-05 por `dart run tool/debt_report.dart`.

- A.1 chamadas `_dyn(...)` (exclui as 3 linhas de declaração do helper): 109
- A.2 `as dynamic`: 0
...
| view_control.dart | 3687 | 41 (33/0/8) | 0 / 0 | 0 | 41 |
