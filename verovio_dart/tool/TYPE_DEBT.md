...
Lavagem de tipo (_dyn + as dynamic + declarações dynamic): 174
Engolidores silenciosos (catch sem rethrow nem log): 2
Supressões de erro de tipo: 0
Dívida total (D = A + B + C): 176

Gerado em 2026-09-05 por `dart run tool/debt_report.dart`.

- A.1 chamadas `_dyn(...)` (exclui as 3 linhas de declaração do helper): 123
- A.2 `as dynamic`: 0
- A.3 declarações/parâmetros `dynamic x` (exclui o helper): 51
...
| view_control.dart | 3714 | 59 (47/0/12) | 0 / 0 | 0 | 59 |
| view_element.dart | 3347 | 90 (59/0/31) | 2 / 2 | 0 | 92 |
