...
Lavagem de tipo (_dyn + as dynamic + declarações dynamic): 91
Engolidores silenciosos (catch sem rethrow nem log): 0
Supressões de erro de tipo: 0
Dívida total (D = A + B + C): 91

Gerado em 2026-09-06 por `dart run tool/debt_report.dart`.

- A.1 chamadas `_dyn(...)` (exclui as 3 linhas de declaração do helper): 57
- A.2 `as dynamic`: 0
- A.3 declarações/parâmetros `dynamic x` (exclui o helper): 34
...
| view.dart | 935 | 0 (0/0/0) | 0 / 0 | 0 | 0 |
| view_beam.dart | 491 | 0 (0/0/0) | 0 / 0 | 0 | 0 |
| view_control.dart | 3701 | 27 (21/0/6) | 0 / 0 | 0 | 27 |
| view_element.dart | 3264 | 53 (30/0/23) | 0 / 0 | 0 | 53 |
| view_graph.dart | 471 | 0 (0/0/0) | 0 / 0 | 0 | 0 |
| view_mensural.dart | 942 | 10 (6/0/4) | 0 / 0 | 0 | 10 |
