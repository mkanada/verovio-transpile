...
## Com erros (4 arquivo(s) com divergência ou sem dado)

| Status | Arquivo | Comparação (C++ acima, Dart abaixo) |
|---|---|---|
| 🟡 | ossia-001 | ![C++ acima, Dart abaixo](../combined/ossia/ossia-001.png) |
| 🟡 | ossia-002 | ![C++ acima, Dart abaixo](../combined/ossia/ossia-002.png) |
| 🟡 | ossia-003 | ![C++ acima, Dart abaixo](../combined/ossia/ossia-003.png) |
| 🟡 | ossia-004 | ![C++ acima, Dart abaixo](../combined/ossia/ossia-004.png) |

## Sem erros (0 arquivo(s) limpos)
